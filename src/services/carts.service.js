          ...
          if (cart) {
            ...
            //Si No hay stock del producto
             if(prod.stock== 0){
              ...
              prodStock.push({ idProduct:prod._id,
                stock: 0});
             ...
             }else{ //Si hay stock del producto y La cantidad es menor
           ...
           //Usamos .createTicket y  Creamos el ticket, una vez creado se modifica el stock y el carrito, 
